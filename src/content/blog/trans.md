...
# Acceptance
Transitioning can be one of the most challenging things a person will ever do, mentally. The pressure of coming
out to everyone, not knowing whether their reactions will be positive or negative. Starting a life-long
medication plan just to be yourself. Not even talking about the whole "accepting the truth" at the beginning.
...
1. Estradiol injections monotherapy
2. Estradiol injections + any blocker (not really needed on injections, but in some cases it might be needed).
3. Transdermal estradiol + GnRH agonists
4. Transdermal estradiol + bicalutamide
---
5. Transdermal estradiol + any other AA (personally would avoid)
6. Oral estradiol + any AA (first couple a months, then avoid)

# Other resources
Here are links to some of the resources which I have found useful during my transition so far. Be careful though, some of the information on some of these sites can be quite outdated (such as the infamous "[table of changes](https://pghrt.diy/#S1.SS12)").
## General information
- [The DIY HRT Directory 2.0](https://diyhrt.info/) - Don't let the name fool you! Apart from hosting DIY related information, it provides information surrounding available forms of estradiol/testosterone and their respective dosages.
- [Transfeminine Science](https://transfemscience.org/) - Site dedicated to providing studies surrounding transfeminine people, including the original [injectable simulator](https://transfemscience.org/misc/injectable-e2-simulator-advanced).
- [estrannai.se](https://estrannai.se/) - A better, more advanced injectables simulator with presets for monotherapies and corrections for missed doses.
- [4mg](https://startwith4mgestradiolenanthateweeklyandtestatonetothreemonths.com/) and [pghrt.diy](https://pghrt.diy/) - Read and be radicalized!

## DIY resources
- [HRT Cafe](https://hrtcafe.net/) - Great repository of vendors selling both pharmaceutical grade and homebrewed HRT.
- [DIYHRT.market](https://diyhrt.market) - Another great repository of vendors.

## Forums
- [r/trans](https://www.reddit.com/r/trans/) - A subreddit for general discussion about trans related topics.
- [r/asktransgender](https://www.reddit.com/r/asktransgender/) - A subreddit dedicated for asking questions about transitioning, for trans folk and their relatives, partners and/or friends.

## Country specific
- 🇨🇿 [Czechia (jsmetransparent.cz)](https://jsmetransparent.cz)
